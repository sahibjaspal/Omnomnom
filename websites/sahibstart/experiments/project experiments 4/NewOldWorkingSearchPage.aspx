      ...
      <span class="icon-bar"></span>
            ...
            <div class="collapse navbar-collapse" id="navbar-main">
                <ul class="nav navbar-nav">
                    ...
                    <li><input id="txtsearch" runat="server"  type="text" class="txtsearch form-control" placeholder="Search for food" /></li>
                    <li>Near By:</li>
                    <li>
                    ...
                    <li><button id="btnsearch" class="btnsearch btn btn-default" type="button">Search</button>
                     </li>
         ...
         <center>
             ...
             <div class="searchfields">
                        <div class="txtsearchkey">
                            ...
                            <div class="nearbylabel"> 
                               </div>
                               <div class="locationdiv"> 
              </div> 
                                  <div class="btnSearchWrapper">   
               </div>
