  ...
  <form runat="server">
   ...
   <div class="toppadding"></div>
    <div>
        ...
        <h3 style="color:white">Project Use: This page displays ther resutls from the yelp api based on the food searched and location entered.
            <br />
            By clicking on any row, you can redirect to a details page that provides even more information. It displays a picture, average rating image,
            <br />
            Contact details, address details etc.
        </h3>
